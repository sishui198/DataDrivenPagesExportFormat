# Name: DDPExportJPG.py
# Purpose: Will export all the data driven pages to JPEG  in the current MXD.
...
def dataDrivenPagesExport(in_mxd, base_name, out_dir, page_resolution=96):
    ...
    try:
        ...
        for page_number in range(1, (mxd.dataDrivenPages.pageCount + 1)):
            ...
            arcpy.mapping.ExportToJPEG(mxd,out_file,resolution=page_resolution)
        del mxd
